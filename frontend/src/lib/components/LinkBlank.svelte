...
<a
	...
	class="link-button"
>
	<span class="visually-hidden">Lien vers {title}</span>
...
<style lang="scss" global>
	...
	.link-button:focus {
		outline: 3px solid #1c274c;
		outline-offset: 2px;
	}

	/* Rendre le texte invisible tout en gardant l'accessibilité */
	.visually-hidden {
		position: absolute;
		width: 1px;
		height: 1px;
